...
from isbn_verifier import is_valid, isbn10_to_isbn13
...
class Isbn10ConversionTest(unittest.TestCase):
    def test_conversion_other(self):
        self.assertEqual(isbn10_to_isbn13("0-135-95705-2"), "9780135957059")

    def test_conversion_another(self):
        self.assertEqual(isbn10_to_isbn13("0-596-10029-9"), "9780596100292")

    def test_conversion(self):
        self.assertEqual(isbn10_to_isbn13("3-598-21508-8"), "9783598215087")

    def test_conversion_with_x(self):
        self.assertEqual(isbn10_to_isbn13("3-598-21507-X"), "9783598215070")

    def test_conversion_without_separating_dashes(self):
        self.assertEqual(isbn10_to_isbn13("3598215088"), "9783598215087")

    def test_conversion_without_separating_dashes_and_x_as_check_digit(self):
        self.assertEqual(isbn10_to_isbn13("359821507X"), "9783598215070")
